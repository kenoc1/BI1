...
class Terminal():
    ...
    def purchasing(self):
        ...
        while more_products != "n":
            ...
            if product["TYP"] == "gewichtsbasiert":
                ...
                product_count = int(input("Anzahl Produkt: "))
    ...
    def sale(self):
        ...
        while more_products != "n":
            ...
            product = self.db.select_product_with_id(product_id)
            if product["TYP"] == "gewichtsbasiert":
                product_weight = float(input("Gewicht Produkt (IBS-lbs): "))
                weight_products.append(product)
                product["PURCHASED_WEIGHT"] = product_weight
        ...
        brutto_sum = sale_sum + tax_sum
        print("Zu bezahlen: " + str("{:.2f}".format(brutto_sum)) + " IB§")
